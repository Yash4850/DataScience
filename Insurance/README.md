...
https://github.com/Yash4850/DataScience/blob/main/Insurance/Figures/Confusion%20Matrix.PNG
...
•	‘Kernel' - Rbf.
I am additionally using ‘XG boost’ just to check if it gives better accuracy.
## Model Evaluation:
